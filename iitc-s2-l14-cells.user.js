// ==UserScript==
// @id             iitc-plugin-s2-l14-cells@setup
// @name           IITC plugin: S2 L14 Cells
// @category       Layer
// @version        0.0.1.20190115.21337
// @namespace      https://github.com/jonatkins/ingress-intel-total-conversion
// @updateURL      https://github.com/piczkaczu/iitc-s2-cells/blob/master/iitc-s2-l14-cells.user.js
// @downloadURL    https://github.com/piczkaczu/iitc-s2-cells/blob/master/iitc-s2-l14-cells.meta.js
// @description    [iitc-20190115.21337] Draw level 14 cells and highlight these where the next stop will create a Gym
...
//(leaving them in place might break the 'About IITC' page or break update checks)
  ...
  plugin_info.pluginId = 's2l14cells';
  // PLUGIN START ///////////////////////////////////////////////////////
  ...
  window.plugin.gympossible.cellOptionsOccupied = {fill: true, color: 'red', fillColor:'red', opacity: 1, weight: 3, fillOpacity:0.1, clickable: false };
  window.plugin.gympossible.cellOptionsEmpty = {fill: false, color: 'orange', opacity: 0.8, weight: 2, clickable: false };
    ...
    window.plugin.gympossible.setDisabledState = function() {
       ...
       var label = $(".leaflet-control-layers-overlays label span:contains('L14 - Gym Cells')").parent();
...
var setup = function() {   
  	if (window.plugin.s2celldrawer === undefined) {
       alert('S2 Cell plugin is required for: L14 Cells');
       return;
    }
    ...
    window.addLayerGroup('L14 - Gym Cells', window.plugin.gympossible.cellsLayer, true);
    window.plugin.gympossible.layerlist['L14 - Gym Cells'] =  window.plugin.gympossible.cellsLayer;
